...
QT_MOC_LITERAL(4, 28, 6), // "params"
QT_MOC_LITERAL(5, 35, 11), // "setProperty"
QT_MOC_LITERAL(6, 47, 4), // "name"
QT_MOC_LITERAL(7, 52, 5), // "value"
QT_MOC_LITERAL(8, 58, 8) // "doUpdate"

    },
    "MpvObject\0onUpdate\0\0command\0params\0"
    "setProperty\0name\0value\0doUpdate"
};
...
void MpvObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->command((*reinterpret_cast< const QVariant(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MpvObject::onUpdate)) {
                *result = 0;
                return;
            }
        }
